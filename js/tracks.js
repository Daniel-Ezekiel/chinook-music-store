import { defaultAlbum } from "./default-album.js";
// counter to track the addition of tracks
let counter = document.querySelectorAll(
  "div.form_control.track_control"
).length;

// select the form for adding albums
const form_Albums = document.querySelector("form");
